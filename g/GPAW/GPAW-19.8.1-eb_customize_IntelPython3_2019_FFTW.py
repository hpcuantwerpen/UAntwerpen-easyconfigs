...
#
# Work around a bug in Intel Python in the 2019b toolchains (solved in 2020)
# The NumPy include files are not included when compiling GPAW.
#
intelpython = os.getenv('EBROOTPYTHON')
include_dirs += [intelpython + '/lib/python3.6/site-packages/numpy/core/include']
